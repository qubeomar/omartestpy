...
from qube.src.api.omartestpycontroller import omartestpyController
from qube.src.api.omartestpycontroller import omartestpyItemController
from qube.src.api.versioncontroller import omartestpyItemVersionController
...
api.add_resource(omartestpyItemVersionController, '/v1/omartestpy/version')
api.add_resource(omartestpyController, '/v1/omartestpy')
api.add_resource(omartestpyItemController, '/v1/omartestpy/<string:entity_id>')
