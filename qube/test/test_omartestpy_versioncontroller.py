...
HELLO_VERSION = "/v1/omartestpy/version"
...
class TestomartestpyVersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_omartestpy_default_version(self, *args, **kwargs):
    ...
    def test_omartestpy_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
